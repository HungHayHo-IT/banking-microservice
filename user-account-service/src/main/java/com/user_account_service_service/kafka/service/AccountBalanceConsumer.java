...
public class AccountBalanceConsumer {
    ...
    public void consumerBalanceUpdate(BalanceUpdateEvent event) {
        ...
        Account account = accountRepository
                .findByAccountNumberForUpdate(event.getAccountNumber())
                .orElseThrow(() ->
        ...
        BalanceUpdateEvent balanceUpdateEventToPublishToNotification =
        ...
        eventPublisher.publishBalanceUpdateNotification(
                balanceUpdateEventToPublishToNotification
        );
    }
}