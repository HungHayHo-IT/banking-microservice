...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendWelcomeEmail(UserRegistrationEvent event) {
        try{
            ...
            Notification notification = Notification.builder()
                    ...
                    .subject("Welcom to " +event.getBankName() + " Your Account is Ready")
                    .message(htmlEmailTemplate)
                    .status(NotificationStatus.SENT)
                    .build();

            sendEmailOut(event.getEmail(), notification.getSubject(), htmlEmailTemplate);
    ...
    public void sendTransactionAlertEmail(BalanceUpdateEvent event) {
        ...
        try{
            ...
            context.setVariable("bankName", "BANK NOW");
            context.setVariable("amount", event.getAmount());
            context.setVariable("currency", "VND");
